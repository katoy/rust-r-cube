...
const CUBE_STATES = [
  {
    name: "solved",
    state: "UUUUUUUUURRRRRRRRFFFFFFFFDDDDDDDDDLLLLLLLLBBBBBBBB",
  },
  {
    name: "superflip",
    state: "URFDLBURFDLBURFDLBURFDLFBUDLBFURDLFBUDLBFURDLFBURD",
  },
  {
    name: "scrambled-1",
    state: "URRFLUURRFLUDURRFLUFDUDURRLFUDURRLFUDURRLFUDLFURDU",
  },
  {
    name: "mixed-colors",
  ...
  {
    name: "partial",
    state: "UUUUUUUU???????U????????F????F??DDDDDDDD???????BBB",
  },
];
 ...
 * キューブ面を Canvas に描画
 */
function drawCubeFace(ctx, startX, startY, faceIndex, state) {
