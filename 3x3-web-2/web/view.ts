    ...
    <div class="workspace">
      ...
      <aside class="panel">
        <div class="panel-section setup"><div class="section-title"><span class="step-index">01</span><h2>キューブを準備</h2></div>
          ...
          <div id="colors-panel" class="tab-panel" role="tabpanel" aria-labelledby="tab-colors" hidden><p>実物のキューブを、白が上・緑が前になるように持って入力します。</p><button id="edit-colors" class="secondary wide">${icon("cube")} 6面の色を入力 ${icon("arrow")}</button></div>
